...
public class ExtendListFooter extends ExtendLayout {
    ...
    float listHeight = DisplayUtils.dpToPx(100);
    ...
    @Override
    protected View createLoadingView(Context context, AttributeSet attrs, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.extend_footer, parent, false);
    }
